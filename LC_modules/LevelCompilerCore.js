...
class LevelCompilerCore {
  ...
  //methods
  testGet() {
    return "Test data from Level Compiler Core.";
  }
  testShow() {
    const idx = this.getIdxById([1, 2, 11, "marker", 8]);
    console.log(
      "F-11-31.6cm(EFD1046.3): " +
        this.projectData.holes[idx[1]].sections[idx[2]].markers[idx[4]]
          .event_free_depth
    );
  }
